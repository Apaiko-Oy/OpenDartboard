...
# --no-arrival 1.1: the annotations README's one "line but not an arrival" row, the
# parked 8 #1514 found on the board at frame zero. #1585 removed 1.3 from this flag:
# the row it named is truth v2.3, the T8, and it arrives (f518-520).
python3 /app/testers/i1511_census.py --log "$RUN/rig22-on.txt" --truth $T22 \
    ...
    --min-compared 4 --no-arrival 1.1 || exit 1
