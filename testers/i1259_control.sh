#!/bin/bash
# #1259: the 1100-cycle mock-footage control, #1257's command unchanged, run by i1259_run.sh.
...
"$BIN" --debug \
  ...
  --width 1280 --height 720 > /run1259/control.out 2> /run1259/control.err
RC=$?
echo "PROGRAM_RC=$RC"
